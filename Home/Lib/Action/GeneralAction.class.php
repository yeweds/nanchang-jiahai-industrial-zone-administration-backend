    ...
    public function can_sell_mx()
    {
        ...
        if (isset($_GET['type'])) {
            ...
            if ($vo['range_id'] == 13) {
                ...
                return;
            } elseif ($vo['range_id'] == 14) {
                //新建县
                if ($type == 'zhuzhai') {
                    $map_r['rtype'] = '住宅';
                } elseif ($type == 'fei_zhuzhai') {
                    $map_r['rtype'] = '非住宅';
                }
            } else {
                if ($type == 'zhuzhai') {
...
//容积率说明
    public function rongjilv_remark($num)
    {
        ...
        } elseif ( ($num <= 3.0 && $num >= 2.0) ) {
            $remark = '<font color=#ff3333>生活</font>';
        } elseif ( ($num < 3.0 && $num >= 1.0) ) {
...
//占地面积
    public function zdmj_remark($area)
    {
        ...
        } elseif (($area_mu < 400 && $area_mu >= 200)) {
            $remark = '<font color=#00cc66>大型社区</font>';
        } elseif (($area_mu < 200 && $area_mu >= 100)) {
